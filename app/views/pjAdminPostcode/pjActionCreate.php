  ...
  <div class="col-sm-12">
    <div class="row">
      <div class="col-lg-9 col-md-8 col-sm-6">
        <h2>  Add new postcode<?php //__('infoAddProductTitle');?></h2>
      </div>
    </div><!-- /.row -->
  ...
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      <div class="ibox-content">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminPostcode&amp;action=pjActionCreate" method="post" id="frmCreatePostcode" autocomplete="off" enctype="multipart/form-data">
          <?php
