<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-sm-12">
    <div class="row">
        ...
        <h2>List of Postcodes<?php //__('infoExtrasTitle');?></h2>
      </div>
    </div><!-- /.row -->
  </div><!-- /.col-md-12 -->
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row">
                	<div class="col-md-4">
                    	<a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminPostcode&amp;action=pjActionCreate" class="btn btn-primary"><i class="fa fa-plus"></i> Add Postcode<?php //__('btnAddExtra') ?></a>
                    </div><!-- /.col-md-6 -->
                    <div class="col-md-4">
