            ...
            <ul class="menu-list" role="tablist">
              ...
              ?>
                <li role="presentation" class="clickCategory <?php echo $k == 0 ? 'active' : '' ?>">
                  ...
                  <a href="#tab<?php echo $v['id']; ?>" aria-controls="tab<?php echo $v['id']; ?>" data-toggle="tab"><?php echo $v['name']; ?></a>
                </li>
              <?php } ?>
            </ul>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div style="text-align: right;" id="cartLocaldines">
            <input type="hidden" id="isPostcodeValidated" value="<?php if (isset($STORAGE['post_code']) || $controller->isFrontLogged()) {
                                                                    echo "1";
                                                                  } else {
                                                                    echo "0";
                                                                  } ?>">
            ...
            <input type="hidden" id="postCodeInSession" value="<?php if (isset($STORAGE['post_code'])) {
                                                                  echo $STORAGE['post_code'];
                                                                } else {
                                                                  echo "";
                                                                } ?>">
          </div>
