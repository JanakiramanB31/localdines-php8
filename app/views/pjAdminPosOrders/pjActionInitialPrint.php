  ...
  <div class="ticket" style="margin: 5px 7px;width: <?php echo $paperWidth; ?>;">
    ...
    <table class="table table-borderless" style="width: <?php echo $paperWidth; ?>;">
      ...
      <tbody>
        ...
        <?php if (PRINT_RECEIPT_QR_CODE) { ?>

          <tr>

            <td colspan="2" style="font-size:14px">

              <img height="150" width="150" src='<?php echo UPLOAD_URL . "/qrcode/QrCodeScanImage.png" ?>'>

              <div style="font-size:14px">QR Menu<br />Click & Collect<br /><br />

                Thank you for ordering from <br />

                <?php echo $tpl['location_arr'][0]['name']; ?>!</div>
            </td>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    // console.log('autoprint', autoRPrint);
    if (autoRPrint == 1) {
      printDivLocal(divName);
    }
