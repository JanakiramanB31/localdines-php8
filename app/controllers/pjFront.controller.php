...
class pjFront extends pjAppController
{
  ...
  public function setWebOrderAvailability()
  {
    $wt_obj = pjWorkingTimeModel::factory();
    $pickup_status = $wt_obj->isServiceAvailable('pickup');
    $delivery_status = $wt_obj->isServiceAvailable('delivery');
