...
class pjAppController extends pjBaseAppController
{
  ...
  public function pjActionAfterInstall()
  {
    ...
    if (
      isset($GLOBALS['CONFIG'], $GLOBALS['CONFIG']["listing_actions"])
  ...
  public static function getClientTokens($option_arr, $data, $salt, $locale_id)
  {
    ...
    $replace = array(
      @$client['c_title'],
      $country,
      pjSanitize::clean(@$client['c_city']),
      pjSanitize::clean(@$client['c_state']),
      "",
      pjSanitize::clean(@$client['c_zip']),
      pjSanitize::clean(@$client['c_address_1']),
      pjSanitize::clean(@$client['c_address_2']),
      pjSanitize::clean(@$client['c_company']),
      pjSanitize::clean(@$auth_client['name']),
      pjSanitize::clean(@$auth_client['email']),
      pjSanitize::clean(@$auth_client['phone']),
      @$auth_client['password'],
      "",
      "",
      "",
      "",
  ...
  public static function getTokens($option_arr, $data, $salt, $locale_id)
  {
    ...
    $replace = array(
      ...
      pjSanitize::clean(@$client['c_city']),
      pjSanitize::clean(@$client['c_state']),
      pjSanitize::clean(@$client['c_notes']),
      pjSanitize::clean(@$client['c_zip']),
      pjSanitize::clean(@$client['c_address_1']),
      pjSanitize::clean(@$client['c_address_2']),
      pjSanitize::clean(@$auth_client['name']),
      pjSanitize::clean(@$auth_client['email']),
      pjSanitize::clean(@$auth_client['password']),
      pjSanitize::clean(@$auth_client['phone']),
      pjSanitize::clean(@$client['c_company']),
      $d_country,
      pjSanitize::clean(@$data['d_city']),
      pjSanitize::clean(@$data['d_state']),
      pjSanitize::clean(@$data['d_zip']),
      pjSanitize::clean(@$data['d_address_1']),
      pjSanitize::clean(@$data['d_address_2']),
      pjSanitize::clean(@$data['d_notes']),
      $payment_method,
      $date_time,
      $subtotal,
      $price_delivery,
